...
class RegisterDomainStep extends React.Component {
	...
	getDomainsSuggestions = ( domain, timestamp, filters ) => callback => {
		...
		const query = {
			...
			...pickBy( filters, value => Number.isFinite( value ) || typeof value === 'boolean' ),
		};
	...
	onSearch = searchQuery => {
		...
		async.parallel(
			[
				...
				this.getDomainsSuggestions( domain, timestamp, this.state.filters ),
			],
